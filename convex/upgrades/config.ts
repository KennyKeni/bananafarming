export const DEFAULT_COST_MULTIPLIER = 2;

export const UPGRADES = [
  { key: "click", name: "Stronger Click", emoji: "💪", baseCost: 5, cps: 0, clickPower: 1, costMultiplier: 5 },
  { key: "cursor", name: "Cursor", emoji: "👆", baseCost: 10, cps: 1, clickPower: 0, costMultiplier: 2 },
  { key: "grandma", name: "Grandma", emoji: "👵", baseCost: 1000, cps: 5, clickPower: 0, costMultiplier: 2 },
  { key: "farm", name: "Farm", emoji: "🌾", baseCost: 100000, cps: 50, clickPower: 0, costMultiplier: 2 },
  { key: "mine", name: "Mine", emoji: "⛏️", baseCost: 10000000, cps: 500, clickPower: 0, costMultiplier: 2 },
  { key: "gstack", name: "Gstack", emoji: "🧠", baseCost: 1000000000, cps: 5000, clickPower: 0, costMultiplier: 2 },
] as const;
